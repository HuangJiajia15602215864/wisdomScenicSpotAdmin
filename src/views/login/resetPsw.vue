...
<template>
  <div>
    <div class="reset-container">
      <el-form ref="resetForm" :model="resetForm" :rules="resetFormRules" autocomplete="off" class="reset-form"
        label-position="left">
        <div class="title">
          智慧景区后台管理系统
        </div>
        <el-card shadow="hover" class="reset-card">
          ...
          <el-form-item prop="phoneNumber" class="reset-input-item">
            <el-input v-model="resetForm.phoneNumber" name="phoneNumber" type="text" placeholder="请输入手机号" />
          </el-form-item>
          <el-form-item prop="code" class="reset-input-item">
            <el-input v-model="resetForm.code" type="number" name="code" placeholder="请输入短信验证码" maxlength="4" />
          ...
          <el-form-item prop="newPassword" class="reset-input-item">
            <el-input v-model="resetForm.newPassword" show-password name="newPassword"
              placeholder="设置新的登录密码(数字+字母，最少6位)" />
          </el-form-item>
          <el-form-item prop="confirmPassword" class="reset-input-item">
            <el-input v-model="resetForm.confirmPassword" name="confirmPassword" show-password placeholder="再次输入登录密码"
              @blur="confirmPsw" />
          </el-form-item>
